<template>
    <div class="goods2" :style="'padding-top:'+elementObj.instMargin/750*10+'rem'" v-if="show">
        <div class="title">
            ...
            <span v-if="elementObj.configType==105||elementObj.configType==106" @click="goodsMore(suList.sucId)">更多<i class="iconfont icon-more"></i></span>
        </div>

        <div v-if="elementObj.configType==106||elementObj.configType==107" class="goods_banner" @click="linkSkip(suList.banner)">
