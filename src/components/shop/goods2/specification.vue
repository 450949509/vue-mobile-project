...
<div v-if="standardType" id="standard">
    <div class="standard">
        <div class='clear standard_title'>
            ...
            <p>
                <b>{{salePrice.toFixed(2)}}<i>福币</i></b>
    ...
    <div class="buy_btn_box">
        <div class="buy_btn" v-if="goodsType==2 || goodsType==3" :class="{'buy_btn_disabled':disabled}" @click="handleClick">
            确定
        </div>
    </div>

    <div id="goods_bottom" v-if="goodsType==1">
...
<script>
    ...
    import {saveCartItem} from '../../../api/getData';
    export default{
        props: {
            goodsStandardList: {
                type: Array,
            ...
            */
            ...
            initSKU() {
                ...
                for(i = 0; i < skuKeys.length; i++) {
                    ...
                    console.log(this.SKUResult[skuKeyAttrs.join(";")])
                }
