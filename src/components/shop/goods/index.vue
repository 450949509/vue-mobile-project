...
<script>
    ...
    import {findMerchantProdetails,MerchantProdAttNameAPPById,skuByMerchantProductId,saveCartItem,SellPlatformMerchantProdByMerchantProdId,startLimitRuleByStandardUnitId} from '../../../api/getData';
    export default{
        ...
        methods:{
            ...
            async startLimitRuleByStandardUnitId() {
                try {
                    const res = await startLimitRuleByStandardUnitId({standardUnitId:this.$route.params.goodsId});
