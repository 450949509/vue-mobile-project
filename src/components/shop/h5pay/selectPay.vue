<template>
    <div class="pay" v-if="payShow">
        ...
        <div class="pay_num">
            <p v-if="orderInfo.orderAmount-orderInfo.needPayCash>0">共{{orderInfo.goodsAccount}}件商品 合计: <span>&yen;{{orderInfo.orderAmount}}</span></p>
...
<script>
    ...
    import {standardOrderQueryAtPayInvoke,standardOrderQueryAtPayMethod,standardPayCancle,nativeWXpaySign,orderPayConfirm,getClientPayTypeByClientId} from '../../../api/getData';
